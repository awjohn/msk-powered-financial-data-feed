...
cat > /home/ec2-user/run-producer.sh << 'EOF'
#!/bin/bash
...
mvn clean package
java -jar target/amazon-msk-samples-1.0-SNAPSHOT.jar producer $BROKERS
EOF

chmod +x /home/ec2-user/run-producer.sh
chown ec2-user:ec2-user /home/ec2-user/run-producer.sh
